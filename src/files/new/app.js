...
function paddingToScrollBar() {
    ...
    if (window.innerWidth >= containerWidth + 60) {
        scrollBar.style.paddingLeft = `${padding}px`;
        scrollBar.style.paddingRight = `${padding}px`;
    }
    if (window.innerWidth <= 1024 && window.innerWidth > 992) {
        scrollBar.style.paddingLeft = `30px`;
        scrollBar.style.paddingRight = `30px`;
    }
    if (window.innerWidth <= 992) {
        scrollBar.style.paddingLeft = `20px`;
        scrollBar.style.paddingRight = `0`;
    }
    if (window.innerWidth <= 768) {
        scrollBar.style.paddingLeft = `15px`;
    }
}
paddingToScrollBar();